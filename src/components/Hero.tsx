  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        <div className="floating absolute top-20 left-10 w-4 h-4 bg-primary/30 rounded-full blur-sm"></div>
        <div
          className="floating absolute top-40 right-20 w-6 h-6 bg-secondary/30 rounded-full blur-sm"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="floating absolute bottom-40 left-20 w-3 h-3 bg-accent/30 rounded-full blur-sm"
          style={{ animationDelay: "4s" }}
        ></div>
        <div
          className="floating absolute bottom-20 right-10 w-5 h-5 bg-primary/30 rounded-full blur-sm"
      ...
      <div className="relative z-20 text-center max-w-4xl mx-auto px-6">
        <div className="glass-card p-12 rounded-2xl">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
            ...
            next-generation web experiences that push boundaries. Passionate about creating scalable, efficient, and
            beautiful web applications that make a difference.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Button
              ...
              size="lg"
              className="group relative overflow-hidden bg-gradient-primary hover:shadow-glow-primary transition-all duration-300 px-8 py-4 text-lg font-semibold"
            >
              <span className="relative z-10">View My Work</span>
              <div className="absolute inset-0 bg-gradient-accent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </Button>
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-primary/30 text-primary hover:bg-primary/10 hover:shadow-glow-primary transition-all duration-300 px-8 py-4 text-lg font-semibold"
            >
              Download Resume
            </Button>
          </div>
