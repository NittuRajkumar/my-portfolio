const Footer = () => {
  ...
  return (
    <footer className="bg-card/50 border-t border-glass-border">
          ...
          <div className="flex justify-center md:justify-end gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-10 h-10 glass rounded-full flex items-center justify-center hover-glow transition-all duration-300 hover:scale-110"
